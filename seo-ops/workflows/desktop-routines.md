...
В первой строке сводки укажи дату запуска и окно данных (последняя дата GSC в снапшоте). Если с последнего файла seo-ops/reports/weekly/weekly_*.md прошло больше 8 дней, добавь строку «Предыдущий плановый запуск был пропущен».
