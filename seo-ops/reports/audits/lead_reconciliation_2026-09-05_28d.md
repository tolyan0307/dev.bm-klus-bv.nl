...
| GA4 form events as % of WP submissions | 62.5% | [GA4, 28d, event-level] ÷ [WP, 28d, lead-level] |
| GA4 `Phone` + `Whatsapp` + `Email` events | 6 | [GA4, 28d, event-level] |
...
- Weekly CSV: `seo-ops/snapshots/normalized/wp/lead_reconciliation_weekly_last28d.csv`
- This report: `seo-ops/reports/audits/lead_reconciliation_2026-09-05_28d.md`
