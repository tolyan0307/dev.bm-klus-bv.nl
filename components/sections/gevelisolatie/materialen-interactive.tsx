...
export interface MaterialenInteractiveProps {
  id: string
  intro: string
  items: MaterialenItem[]
  systeemopbouwH3: string
  systeemopbouwLagen: string[]
}
...
export default function MaterialenInteractive({
  id,
  intro,
  items,
  systeemopbouwH3,
  systeemopbouwLagen,
}: MaterialenInteractiveProps) {
