...
import {
  Phone, ArrowRight, CheckCircle2, Check,
  MapPin, Clock, Wrench, Layers, PaintBucket,
  Brush, AlignLeft, Home, Ruler, MoveVertical,
  AlertTriangle, Palette, Camera, Droplets,
} from "lucide-react";
import { buildPageMetadata } from "@/lib/seo/meta";
import {
  hero, toc, core, kosten, offerte,
  verfsoorten, voorbereiding, techniek,
  onderhoud, werkgebied, faq as faqData, internalLinks,
            ...
            <div className="flex">
              <div className="flex flex-col gap-6 pb-16 sm:pb-20 lg:pb-24 max-w-2xl">
                ...
                <h1 className="text-balance text-3xl font-bold leading-[1.08] tracking-tight text-white sm:text-4xl lg:text-5xl xl:text-[3.75rem]">
                  Gevel schilderen (buitenmuur verven):{" "}
      ...
      <main className="overflow-hidden bg-background pb-16 sm:pb-20 lg:pb-24">
          ...
          <section id={core.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <SectionHeading plain="Gevel schilderen —" accent="wat levert het op?" />
                ...
                <div className="relative min-h-64 lg:min-h-0">
                  ...
                  <div className="absolute bottom-5 left-5">
                    ...
                    <p className="mt-2 text-sm font-semibold leading-snug text-white drop-shadow">
                      Fraaie gevel én<br />duurzame bescherming
                    </p>
                  </div>
                </div>
          ...
          {/* ══ KOSTEN — tinted bg ══ */}
          <section id={kosten.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24 relative before:absolute before:inset-y-0 before:-inset-x-[50vw] before:-z-10 before:bg-secondary/40">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <SectionTagline>Kosten</SectionTagline>
              <SectionHeading plain="Kosten gevel schilderen" accent="(prijs per m²)" />
                ...
                {[
                  ...
                  <div
                    ...
                    className={`relative flex flex-col overflow-hidden rounded-2xl border bg-card p-6 transition-shadow hover:shadow-md ${
                      highlight ? "border-2 border-primary shadow-sm" : "border-border"
                    }`}
                  >
                    {highlight && (
                    ...
                    <p className={`text-[10px] font-bold uppercase tracking-widest ${highlight ? "text-primary" : "text-muted-foreground"}`}>
                      {label}
                    </p>
                    ...
                    {!highlight && (
                      <div className="absolute bottom-0 left-0 h-[3px] w-0 bg-primary/40 transition-all duration-300 group-hover:w-full" />
                    )}
                  </div>
                ))}
              </div>
              <p className="mt-3 whitespace-pre-line text-xs text-muted-foreground">{kosten.table.note}</p>

              {/* Price factors — icon grid */}
              <div className="mt-10">
                <div className="mb-5 flex items-center gap-3">
                  <div className="h-px w-10 bg-primary/30" />
                  <p className="text-sm font-semibold text-foreground">{kosten.priceFactors.label}</p>
                </div>
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  {[
                    { icon: Layers,      text: "Bereikbaarheid (begane grond, steiger of hoogwerker)" },
                    { icon: Droplets,    text: "Mate en methode van reiniging (softwash, stoomreiniging)" },
                    { icon: Wrench,      text: "Herstel van scheuren, losse voegen of beschadigingen" },
                    { icon: PaintBucket, text: "Primer, voorstrijk of fixeermiddel (type en hoeveelheid)" },
                    { icon: AlignLeft,   text: "Afplakken van kozijnen, plinten en aangrenzende vlakken" },
                    { icon: Brush,       text: "Gekozen verfsoort (silicaat, siloxaan of acryl)" },
          ...
          {/* ══ OFFERTE — white bg ══ */}
          <section id={offerte.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <SectionTagline>Offerte</SectionTagline>
              <SectionHeading plain="Offerte voor" accent="gevel schilderen" />

              {/* Two-column: left content + CTA, right full-height image */}
              <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_320px] lg:items-stretch">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  {/* "Wat hebben wij nodig?" — icon grid */}
                  <div>
                    <div className="mb-4 flex items-center gap-3">
                      <div className="h-px w-10 bg-primary/30" />
                      <p className="text-sm font-semibold text-foreground">Wat hebben wij nodig?</p>
                    </div>
                    <div className="grid gap-3 sm:grid-cols-2">
                      {([
                        { icon: Home,          label: "Type gevel",         desc: "Baksteen, pleister/stuc of beton" },
                        { icon: Ruler,         label: "Oppervlak",          desc: "Indicatie van het te schilderen m²" },
                        { icon: MoveVertical,  label: "Hoogte & toegang",   desc: "Begane grond, 1e verdieping, steiger?" },
                        { icon: AlertTriangle, label: "Staat van de gevel", desc: "Afbladderen, scheuren, loszittend?" },
                        { icon: Palette,       label: "Gewenste kleur",     desc: "Kleur of kleurrichting" },
                        { icon: Camera,        label: "Foto's (optioneel)", desc: "Versnelt onze beoordeling aanzienlijk" },
                  ...
                  <div className="mt-auto overflow-hidden rounded-2xl border border-border bg-card">
                    ...
                    <div className="flex flex-col gap-4 px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex flex-wrap gap-x-5 gap-y-2">
                        {["Snelle reactie tijdens openingstijden", "Opname ter plaatse", "Duidelijke offerte met scope"].map((t) => (
                ...
                <div className="relative min-h-64 overflow-hidden rounded-2xl border border-border shadow-sm">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-white/60">Transparant</p>
          ...
          {/* ══ VERFSOORTEN — tinted bg ══ */}
          <section id={verfsoorten.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24 relative before:absolute before:inset-y-0 before:-inset-x-[50vw] before:-z-10 before:bg-secondary/40">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <SectionTagline>Verfsoorten</SectionTagline>
              <SectionHeading plain="Silicaat (KEIM) of" accent="siloxaan — welke verf?" />
              ...
              <div className="mt-10 grid gap-5 lg:grid-cols-[280px_1fr]">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-border">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-white/60">Systeemkeuze</p>
                    <p className="mt-0.5 text-sm font-semibold leading-snug text-white">Passend bij uw ondergrond</p>
                  </div>
                </div>

                {/* Two comparison cards */}
                <div className="grid gap-5 sm:grid-cols-2">
                  <div className="flex flex-col rounded-2xl border-2 border-primary/20 bg-card overflow-hidden">
                    <div className="border-b border-primary/15 bg-primary/5 px-5 py-4">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-primary">Mineraal · Dampopen</p>
                      ...
                      <ul className="space-y-2">
                        {verfsoorten.subsections[0].bullets?.map((b) => (
                          <li key={b} className="flex items-start gap-2.5">
                            ...
                            <span className="text-xs leading-snug text-foreground/70 sm:text-sm">{b}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                  ...
                  <div className="flex flex-col rounded-2xl border border-border bg-card overflow-hidden">
                    <div className="border-b border-border bg-muted/50 px-5 py-4">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Waterafstotend · Flexibel</p>
                      <h3 className="mt-1 text-base font-bold text-foreground leading-snug">
              ...
              <div className="mt-5 overflow-hidden rounded-2xl border border-border bg-card">
                <div className="grid sm:grid-cols-[4px_1fr]">
                  <div className="hidden sm:block bg-primary/30" />
                  <div className="px-6 py-6">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary">Begrippen uitgelegd</p>
              ...
              <div className="mt-5 flex gap-3 rounded-xl border border-primary/20 bg-primary/5 px-5 py-4">
                <div className="mt-1 w-[3px] shrink-0 self-stretch rounded-full bg-primary/40" />
                <p className="text-sm italic leading-relaxed text-muted-foreground">{verfsoorten.caution}</p>
              </div>
            </div>
          </section>

          {/* ══ VOORBEREIDING — white bg ══ */}
          <section id={voorbereiding.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <SectionTagline>Voorbereiding</SectionTagline>
              <SectionHeading plain="Voorbereiding en primer:" accent="zo blijft het lang mooi" />

              <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_300px] lg:gap-12 lg:items-stretch">
                {/* Accordion steps */}
                {/* Numbered steps */}
                ...
                {/* Right column — stretches to full accordion height */}
                <div className="flex flex-col gap-4">
                  ...
                  <div className="relative min-h-56 flex-1 overflow-hidden rounded-2xl border border-border shadow-sm">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-transparent to-transparent" />
                    <div className="absolute bottom-4 left-4 right-4">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-white/60">Vakmanschap</p>
                      <p className="mt-0.5 text-sm font-semibold leading-snug text-white">
                  ...
                  <div className="flex gap-3 rounded-xl border border-primary/20 bg-primary/5 px-4 py-4">
                    ...
                    <p className="text-xs italic leading-relaxed text-muted-foreground">
                      Wij slaan nooit voorbereidingsstappen over — een degelijke basis garandeert een duurzaam eindresultaat.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* ══ TECHNIEK — tinted bg ══ */}
          <section id={techniek.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24 relative before:absolute before:inset-y-0 before:-inset-x-[50vw] before:-z-10 before:bg-secondary/40">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <SectionTagline>Techniek</SectionTagline>
              <SectionHeading plain="Baksteen, pleister" accent="en beton: aanpak per ondergrond" />
                ...
                {[
                  ...
                  >
                    ...
                    <div className="relative h-28 overflow-hidden">
                      ...
                      />
                      {/* Dark scrim for tag readability */}
                    ...
                    <div className="flex flex-1 flex-col gap-3 p-5">
                      <h3 className="text-base font-bold leading-snug text-foreground">{sub.h3}</h3>
                      <p className="text-sm leading-relaxed text-muted-foreground">{sub.body}</p>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div className="grid sm:grid-cols-[auto_1fr]">
                  <div className="flex items-center justify-center border-b border-border bg-muted/60 px-6 py-5 sm:border-b-0 sm:border-r sm:px-8">
                    <div className="flex flex-col items-center gap-2">
                      <svg viewBox="0 0 48 48" fill="none" className="h-10 w-10 text-primary/60" aria-hidden>
                        <circle cx="24" cy="20" r="8" stroke="currentColor" strokeWidth="2" fill="currentColor" fillOpacity=".08"/>
                        <path d="M24 4v4M24 32v4M8 20H4M44 20h-4M12.7 8.7l-2.8-2.8M38.1 34.1l-2.8-2.8M12.7 31.3l-2.8 2.8M38.1 5.9l-2.8 2.8" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                      </svg>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">{techniek.weather.label}</p>
                    </div>
                  </div>
                  <div className="px-6 py-5">
                    <div className="mb-3 flex flex-wrap gap-2">
                      {["Geen regen", "RV niet te hoog", "5°C – 30°C"].map((cond) => (
                        <span
                          key={cond}
                    ...
                    <p className="text-sm leading-relaxed text-muted-foreground">{techniek.weather.body}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* ══ ONDERHOUD — white bg ══ */}
          <section id={onderhoud.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-10 grid gap-5 lg:grid-cols-[300px_1fr] lg:items-stretch">
                ...
                <div className="flex flex-col overflow-hidden rounded-2xl border border-border bg-card">
                  <div className="border-b border-border bg-secondary/40 px-5 py-4">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary">Verwachte levensduur</p>
                    <p className="mt-0.5 text-sm font-semibold text-foreground">Per verfsysteem</p>
                  </div>
                  <div className="flex-1 divide-y divide-border">
                    {[
                      { label: "Silicaatverf (KEIM)", years: "15–25", pct: 90, note: "Mineraal, UV-bestendig" },
                      { label: "Siloxaanverf",        years: "10–15", pct: 65, note: "Waterafstotend, flexibel" },
                      { label: "Acrylverf",           years: "7–12",  pct: 48, note: "Breed inzetbaar" },
                    ].map(({ label, years, pct, note }) => (
                      <div key={label} className="px-5 py-4">
                        <div className="flex items-baseline justify-between gap-2">
                          <p className="text-sm font-semibold text-foreground">{label}</p>
                          <p className="shrink-0 text-base font-black text-primary">
                            {years}<span className="ml-0.5 text-xs font-normal text-muted-foreground"> jr</span>
                          </p>
                        </div>
                  ...
                  <div className="border-t border-border bg-secondary/30 px-5 py-3">
                    <p className="text-[10px] italic text-muted-foreground">Afhankelijk van ligging, onderhoud en ondergrond.</p>
                  </div>
                </div>

                {/* Maintenance tips card — same header style */}
                <div className="flex flex-col overflow-hidden rounded-2xl border border-border bg-card">
                  <div className="border-b border-border bg-secondary/40 px-5 py-4">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary">Onderhoudstips</p>
                    <p className="mt-0.5 text-sm font-semibold text-foreground">Zo houdt u de verf lang mooi</p>
                  </div>
                  <div className="flex-1 divide-y divide-border">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-4 px-5 py-4 transition-colors hover:bg-secondary/30">
                        <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary/8">
                          <Icon className="h-4 w-4 text-primary" />
                        </div>
                        <p className="self-center text-sm leading-snug text-muted-foreground">{tip}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-[auto_1fr]">
                  <div className="flex items-center justify-center bg-primary/10 px-5 py-5 sm:px-6">
                    <div className="text-center">
                      ...
                      <p className="mt-1 text-[10px] font-bold uppercase tracking-widest text-primary">Pro tip</p>
                    </div>
                  </div>
                  <div className="px-5 py-5">
                    <p className="text-sm font-semibold text-foreground">Kleurkeuze & UV-verwering</p>
                    <p className="mt-1.5 text-sm italic leading-relaxed text-muted-foreground">{onderhoud.colorNote}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-16">
                <div>
                  ...
                  <p className="mt-4 max-w-lg text-base leading-relaxed text-white/55">
                    Vraag vandaag nog uw gratis inspectie aan. Wij beoordelen uw gevel ter plaatse en
                    stellen een heldere offerte op — zonder verplichtingen.
                  </p>
                  <div className="mt-6 flex flex-wrap gap-x-6 gap-y-2">
                    {["Snelle reactie tijdens openingstijden", "Vakkundige inspectie", "Duidelijke vaste prijs"].map((t) => (
                      <div key={t} className="flex items-center gap-2">
          ...
          {/* ══ FAQ — tinted bg full-bleed ══ */}
          <section id={faqData.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24 relative before:absolute before:inset-y-0 before:-inset-x-[50vw] before:-z-10 before:bg-secondary/40">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="lg:col-span-5">
                  <div className="lg:sticky lg:top-32">
                    ...
                    <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground sm:text-base">
                      Alles wat u wilt weten over gevel schilderen — van kosten en verfkeuze tot voorbereiding en onderhoud.
                    </p>
          ...
          {/* ══ WERKGEBIED — white bg ══ */}
          <section id={werkgebied.id} className="scroll-mt-24 py-16 sm:py-20 lg:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="relative overflow-hidden rounded-3xl border border-border bg-card">
                ...
                >
                  <path
                    ...
                    stroke="#1A1A1A" strokeWidth="2" fill="#1A1A1A"
                  />
                  <circle cx="175" cy="185" r="10" fill="#E8600A" opacity="0.8" />
                  <circle cx="175" cy="185" r="22" stroke="#E8600A" strokeWidth="1.5" opacity="0.35" />
                  <circle cx="175" cy="185" r="36" stroke="#E8600A" strokeWidth="1" opacity="0.18" />
                </svg>
                <div className="relative z-10 px-6 py-10 sm:px-10 sm:py-12">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="h-px w-8 bg-primary/50" />
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary">Werkgebied</p>
                  </div>
                  ...
                  <div className="mt-8">
                    <p className="mb-3 text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Steden &amp; gemeenten</p>
                    <div className="flex flex-wrap gap-2">
                      {werkgebied.cityChips.map((city, i) => (
                        ...
                        >
                          {i === 0 && (
                            <svg viewBox="0 0 8 8" className="h-2 w-2 fill-white" aria-hidden>
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">{werkgebied.outsideNote}</p>
                    <Link
                      href="/contact/"
