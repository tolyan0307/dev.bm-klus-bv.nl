...
import { faq } from "@/lib/content/muren-stucen";

export default function FaqAccordionInner() {
        ...
        return (
          ...
          >
            <button
              ...
              aria-controls={`faq-ms-answer-${i}`}
              id={`faq-ms-question-${i}`}
              className="flex w-full items-start justify-between gap-4 p-6 text-left transition-colors hover:bg-secondary/20"
            >
              <div className="flex min-w-0 items-start gap-4">
                <span
                  className={`mt-0.5 shrink-0 text-lg font-bold tabular-nums transition-colors ${
            ...
            >
              <div className="overflow-hidden">
                <div
                  id={`faq-ms-answer-${i}`}
                  role="region"
                  aria-labelledby={`faq-ms-question-${i}`}
