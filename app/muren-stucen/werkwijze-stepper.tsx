...
import { werkwijze } from "@/lib/content/muren-stucen";

const ICONS = [ClipboardList, ShieldCheck, Wrench, Layers, Paintbrush2, CheckCircle2];

const LABELS = ["Opname", "Afplakken", "Ondergrond", "Gaasband", "Stucken", "Oplevering"];

const DETAILS = [
  "We komen ter plaatse voor een grondige opname: de staat van de wanden, het gewenste afwerkingsniveau (behangklaar of sausklaar) en de oppervlakten worden samen besproken en vastgelegd.",
  "Vloer, kozijnen, deuren en alle aangrenzende vlakken worden zorgvuldig afgedekt en afgeplakt zodat er nergens stucwerk terechtkomt waar het niet hoort.",
  "De ondergrond wordt gereinigd, losse delen worden verwijderd en scheuren worden gerepareerd. Waar nodig brengen we een voorstrijk of primer aan voor een optimale hechting.",
  "Op alle hoeken, naden en bestaande scheuren wordt glasvezel gaasband aangebracht. Dit voorkomt doorscheurende haarscheurtjes in de nieuwe afwerklaag.",
  "De stuclaag wordt vakkundig aangebracht en met een spaan egaal afgewerkt tot het gewenste eindniveau: strak behangklaar of extra glad sausklaar.",
  "Na droging controleren we het volledige oppervlak. Beschermmateriaal wordt verwijderd, de ruimte wordt schoongemaakt en u inspecteert het resultaat samen met ons.",
];
