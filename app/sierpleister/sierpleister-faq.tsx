...
import { faq } from "@/lib/content/sierpleister"

export function SierpleisterFaq() {
        ...
        return (
          ...
          >
            <button
              ...
              aria-controls={`sp-faq-answer-${i}`}
              id={`sp-faq-question-${i}`}
            ...
            >
              <div className="overflow-hidden">
                <div
                  id={`sp-faq-answer-${i}`}
                  role="region"
                  aria-labelledby={`sp-faq-question-${i}`}
