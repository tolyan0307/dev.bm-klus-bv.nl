...
export default function MaterialenPage() {
  ...
  const materialenItems: MaterialenItem[] = materialen.map((mat) => {
    ...
    const damp = dampBadge[mat.dampopen]
    return {
      materiaal: mat.materiaal,
      lambda: mat.lambda,
      brandKey: mat.brandKey,
      brandLabel: brand.label,
      brandCls: brand.cls,
      dampopen: mat.dampopen,
      dampLabel: damp.label,
      dampCls: damp.cls,
      wanneer: mat.wanneer,
      pluspunt: mat.pluspunt,
      aandachtspunt: mat.aandachtspunt,
      beschrijving: mat.beschrijving,
      lambdaScore: lambdaScore[mat.materiaal] ?? 2,
      imgSrc: getFallbackSrc(mat.baseName, DIR, "serviceCard"),
      imgSrcSet: buildSrcSet(mat.baseName, DIR, "serviceCard"),
    }
  })
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-14">
          ...
          <div className="space-y-20">
            ...
            <section id="vergelijking" className="scroll-mt-24">
              ...
              {/* Interactive tab switcher — client leaf */}
              <MaterialenVergelijking items={materialenItems} />
