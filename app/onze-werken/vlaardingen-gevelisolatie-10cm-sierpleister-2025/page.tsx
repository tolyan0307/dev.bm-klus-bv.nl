...
import { beforeImages, afterImages } from "@/lib/content/projects/vlaardingen-gevelisolatie-10cm-sierpleister-2025"
...
export const metadata = buildPageMetadata(
  ...
  {
    title: "Vlaardingen gevelisolatie 10 cm sierpleister – 2025",
    description:
      "Project in Vlaardingen: gevelrenovatie met 10 cm gevelisolatie, sierpleister 1,5 mm, nieuwe raamdorpels en hoekafwerking met steenstrips.",
  },
)

// ─── Data ─────────────────────────────────────────────────────────────────────
const heroBullets = [
  "10 cm buitengevelisolatie met mechanische bevestiging (gevelpluggen 15 cm)",
  "Glasvezelwapening met wapeningslaag + sierpleister 1,5 mm",
  "Nieuwe raamdorpels en versterkte hoeken met profielen en steenstrips",
]

const werkzaamheden = [
  {
    title: "Opname van gevel, raamdorpels en hoekzones",
    body: "We hebben de bestaande gevel beoordeeld op isolatie, vervuiling, de staat van de raamdorpels en scheurvorming/onregelmatigheden in de hoeken.",
  },
  {
    title: "Aanbrengen van 10 cm buitengevelisolatie",
    body: "De gevel is voorzien van 10 cm isolatie en mechanisch bevestigd met gevelpluggen van 15 cm als basis voor de vernieuwde gevelopbouw.",
  },
  {
    title: "Wapeningslaag met glasvezelwapening",
    body: "Na de isolatielaag is glasvezelwapening met een wapeningslaag aangebracht als versterkte ondergrond voor de afwerking.",
  },
  {
  ...
  {
    title: "Vervangen van raamdorpels en afwerken van hoeken",
    body: "De oude raamdorpels zijn zorgvuldig gedemonteerd en vervangen. De hoeken zijn versterkt met profielen en afgewerkt met steenstrips.",
  },
]

const bevindingen = [
  {
    title: "Onvoldoende isolatie en vervuilde gevel",
    body: "De bestaande gevel had onvoldoende isolatie en was zichtbaar vervuild, waardoor zowel uitstraling als gevelopbouw verbetering vroegen.",
  },
  {
    title: "Versleten raamdorpels",
    body: "De oude raamdorpels waren versleten en sloten niet meer passend aan op de gewenste vernieuwde gevelafwerking.",
  },
  {
    title: "Scheuren en onregelmatigheden in de hoeken",
    body: "De hoekzones vertoonden scheuren en onregelmatigheden, waardoor extra aandacht voor versterking en nette afwerking nodig was.",
  },
  {
    title: "Wens voor verbetering van uitstraling en isolatie",
    body: "De bewoners wilden een oplossing die zowel de gevelisolatie als het uiterlijk van de woning duidelijk zou verbeteren.",
  },
]

const resultaten = [
  {
    title: "Vernieuwde en geïsoleerde gevelopbouw",
    body: "De woning is voorzien van 10 cm buitengevelisolatie met een gewapende opbouw en sierpleister 1,5 mm als afwerklaag.",
  },
  {
    title: "Strak en modern gevelbeeld",
    body: "De combinatie van sierpleister, nieuwe raamdorpels en verzorgde hoekdetails geeft de gevel een strak en modern uiterlijk.",
  },
  {
    title: "Versterkte hoekdetails",
    body: "De hoeken zijn versterkt met profielen en afgewerkt met steenstrips als functionele en visuele verbetering van de geveldetails.",
  },
  {
    title: "Verbeterde buitenschil van de woning",
    body: "Door de vernieuwde isolatie- en afwerkopbouw is de buitenschil van de woning technisch beter opgebouwd dan in de oude situatie.",
  },
]

const detailCards = [
  {
    title: "Mechanische bevestiging met pluggen 15 cm",
    body: "De 10 cm gevelisolatie is mechanisch bevestigd met gevelpluggen van 15 cm als onderdeel van de gevelopbouw.",
  },
  {
    title: "Glasvezelwapening met wapeningslaag",
    body: "Versterkte laag aangebracht als stabiele basis onder de sierpleisterafwerking.",
  },
  {
    title: "Nieuwe raamdorpels",
    body: "Oude raamdorpels zijn zorgvuldig gedemonteerd en vervangen voor vernieuwde raamdetails.",
  },
  {
    title: "Hoeken met profielen en steenstrips",
    body: "Hoekzones versterkt met profielen en afgewerkt met steenstrips voor een nette en robuuste detaillering.",
  },
]

const materialen = [
  { label: "Gevelisolatie", value: "10 cm buitengevelisolatie" },
  { label: "Bevestiging", value: "Gevelpluggen 15 cm (mechanische bevestiging)" },
  { label: "Wapening", value: "Glasvezelwapening met wapeningslaag" },
  { label: "Sierpleister", value: "Korrelstructuur 1,5 mm" },
  { label: "Raamdorpels", value: "Nieuwe raamdorpels" },
  { label: "Hoekafwerking", value: "Hoekprofielen + steenstrips" },
]
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function VlaardingenGevelisolatie10cmProjectPage() {
  return (
    <>
      {projectPageSchema({
        title: "Vlaardingen gevelisolatie 10 cm sierpleister – 2025",
        description:
          "Project in Vlaardingen: gevelrenovatie met 10 cm gevelisolatie, sierpleister 1,5 mm, nieuwe raamdorpels en hoekafwerking met steenstrips.",
        url: `${SITE.canonicalBase}/onze-werken/vlaardingen-gevelisolatie-10cm-sierpleister-2025/`,
        image: "/images/projects/vlaardingen-gevelisolatie-10cm-na-01.webp",
        city: "Vlaardingen",
        year: 2025,
  ...
  />
        ...
        <div className="relative z-10 container-default flex flex-col justify-between min-h-[80vh] lg:min-h-[65vh]">
          ...
          <nav aria-label="Breadcrumb" className="pt-28 sm:pt-32 lg:pt-36 mb-7">
            <ol className="flex flex-wrap items-center gap-1.5 text-sm" style={{ color: "rgba(255,255,255,0.65)" }}>
              ...
              <li aria-hidden><ChevronRight className="h-3.5 w-3.5" /></li>
              <li className="font-medium text-white" aria-current="page">Vlaardingen (2025)</li>
            </ol>
          </nav>
          ...
          <h1 className="text-balance text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl max-w-3xl">
            Vlaardingen: gevelisolatie 10 cm &amp; sierpleister 1,5 mm (2025)
          </h1>
      ...
      <section className="section-spacing border-b border-border" aria-labelledby="werkzaamheden-heading">
        <div className="container-default">
          ...
          <p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground">
            Van opname tot 10 cm isolatie, wapeningslaag, sierpleister en vernieuwde raamdorpels en hoeken.
          </p>
      ...
      <section className="section-spacing border-b border-border" aria-labelledby="na-heading">
        <div className="container-default">
          ...
          <p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground">
            Een vernieuwde en geïsoleerde gevel met strakke afwerking.
          </p>
