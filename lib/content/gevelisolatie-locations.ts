...
export const locations: LocationData[] = [
  {
    ...
    intro:
      "BM klus BV is gevestigd in Rotterdam en verzorgt buitengevelisolatie (ETICS) voor woningen en bedrijfspanden in heel Rotterdam en directe omgeving. Van Kralingen tot Hillegersberg, van IJsselmonde tot Overschie — wij komen bij u langs voor een opname op locatie en offerte.",
    localContext:
    ...
    faq: [
      {
        ...
        antwoord:
          "De prijs voor buitengevelisolatie in Rotterdam hangt af van het type woning, de geveloppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
        vraag: "Heb ik een vergunning nodig in Rotterdam?",
        antwoord:
          "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Rotterdam. Beschermde stadsgezichten, monumentstatus of welstandseisen kunnen van invloed zijn. Controleer altijd de actuele regels via de gemeente en het Omgevingsloket.",
      },
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Rotterdam. Beschermde stadsgezichten (bijv. Delfshaven, Kralingen) en welstandseisen kunnen van invloed zijn. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie (ETICS) voor woningen en bedrijfspanden in Den Haag en omgeving. Van Loosduinen tot Leidschenveen, van Scheveningen tot Ypenburg — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Den Haag ligt op ±25 km van ons kantoor in Rotterdam — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Den Haag?",
        antwoord:
          "De prijs voor buitengevelisolatie in Den Haag hangt af van het type woning, de geveloppervlakte en de gekozen afwerking (bijv. pleisterafwerking of steenstrips). Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
  ...
  },
  {
    ...
    afstanden: "Delft ligt op ±15 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Delft?",
        antwoord:
          "De kosten voor buitengevelisolatie in Delft hangen af van het type woning, de oppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "De binnenstad van Delft is beschermd stadsgezicht. Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Delft. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    afstanden: "Dordrecht ligt op ±25 km van Rotterdam — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Dordrecht?",
        antwoord:
          "De kosten voor buitengevelisolatie in Dordrecht hangen af van het type woning, de oppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "De historische binnenstad (eiland van Dordrecht) heeft beschermd stadsgezicht. Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Dordrecht. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie (ETICS) voor woningen en bedrijfspanden in Schiedam. Van Nieuwland tot Groenoord, van West-Frankelandsepolder tot Kethel — wij adviseren u op locatie.",
    localContext:
    ...
    faq: [
      {
        ...
        antwoord:
          "De prijs voor buitengevelisolatie in Schiedam hangt af van de geveloppervlakte, de afwerking en de staat van de ondergrond. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "De historische binnenstad van Schiedam (jeneverstad) kent beschermd stadsgezicht. Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Schiedam. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    afstanden: "Vlaardingen ligt op ±15 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Vlaardingen?",
        antwoord:
          "De kosten voor buitengevelisolatie in Vlaardingen hangen af van het woningtype, de oppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Vlaardingen. Het oude centrum kan aanvullende eisen hebben. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie (ETICS) voor woningen en bedrijfspanden in Leiden en omgeving. Van de Merenwijk tot Stevenshof, van Leiden-Noord tot de Professorenwijk — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Leiden ligt op ±35 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Leiden?",
        antwoord:
          "De prijs voor buitengevelisolatie in Leiden hangt af van het type woning, de oppervlakte en de gekozen afwerking (bijv. pleisterafwerking of steenstrips). Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Gouda en omgeving. Van Goverwelle tot Bloemendaal, van de Plaswijckbuurt tot Kort Haarlem — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Gouda ligt op ±30 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Gouda?",
        antwoord:
          "De kosten voor buitengevelisolatie in Gouda hangen af van het type woning, de oppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "De binnenstad van Gouda is beschermd stadsgezicht. Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Gouda. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie (ETICS) voor woningen en bedrijfspanden in Zoetermeer. Van Palenstein tot Meerzicht, van Buytenwegh tot Rokkeveen — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Zoetermeer ligt op ±25 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Zoetermeer?",
        antwoord:
          "De prijs voor buitengevelisolatie in Zoetermeer hangt af van de geveloppervlakte, de afwerking en de staat van de ondergrond. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Zoetermeer. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Capelle aan den IJssel. Van Schollevaar tot Oostgaarde, van Schenkel tot Middelwatering — wij adviseren u op locatie.",
    localContext:
    ...
    faq: [
      {
        ...
        antwoord:
          "De kosten voor buitengevelisolatie in Capelle aan den IJssel hangen af van het woningtype, de oppervlakte en de afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Capelle aan den IJssel. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Spijkenisse en de gemeente Nissewaard. Van de Akkers tot Waterland, van Vogelenzang tot de Hoek — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Spijkenisse ligt op ±20 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Spijkenisse?",
        antwoord:
          "De prijs voor buitengevelisolatie in Spijkenisse hangt af van de geveloppervlakte, de afwerking en de staat van de ondergrond. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Nissewaard. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Barendrecht. Van Carnisselande tot het oude dorp, van de Oranjewijk tot Vrijheidsakker — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Barendrecht ligt op ±10 km van ons kantoor — wij werken in de regio Rotterdam en directe omgeving.",
    faq: [
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Barendrecht. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Ridderkerk. Van Drievliet tot Bolnes, van Slikkerveer tot Rijsoord — wij adviseren u op locatie over de beste aanpak.",
    localContext:
    ...
    afstanden: "Ridderkerk ligt op ±15 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Ridderkerk?",
        antwoord:
          "De prijs voor buitengevelisolatie in Ridderkerk hangt af van de geveloppervlakte, het woningtype en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Alphen aan den Rijn en omgeving. Van de Ridder Huysmanlaan tot Kerk en Zanen, van de Lage Zijde tot Ridderveld — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Alphen aan den Rijn ligt op ±40 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Alphen aan den Rijn?",
        antwoord:
          "De kosten voor buitengevelisolatie in Alphen aan den Rijn hangen af van het type woning, de oppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Alphen aan den Rijn. In het centrum kunnen aanvullende regels gelden. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Maassluis. Van het Balkon tot Sluispolder, van Koningshoek tot de Dijkpolder — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Maassluis ligt op ±20 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Maassluis?",
        antwoord:
          "De prijs voor buitengevelisolatie in Maassluis hangt af van het woningtype en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
    ...
    vergunningTip: "Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Maassluis. Het oude centrum kan aanvullende eisen hebben. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    description:
      "Buitengevelisolatie (ETICS) in Hellevoetsluis (Voorne aan Zee). Stuc, sierpleister of steenstrips. Opname op locatie, offerte per m². Specialist regio Rotterdam.",
    h1: "Gevelisolatie in Hellevoetsluis",
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Hellevoetsluis en op Voorne-Putten. Van Nieuw-Helvoet tot de Vesting, van Kickersbloem tot Zuiderpark — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Hellevoetsluis ligt op ±35 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
    ...
    vergunningTip: "In de Vesting van Hellevoetsluis kunnen regels voor beschermd stadsgezicht van toepassing zijn. Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van uw gemeente. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie (ETICS) voor woningen en bedrijfspanden in Breda en omgeving. Van Brabantpark tot Hoge Vucht, van Princenhage tot Tuinzigt — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Breda ligt op ±55 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Breda?",
        antwoord:
          "De prijs voor buitengevelisolatie in Breda hangt af van het type woning, de oppervlakte en de gekozen afwerking (bijv. pleisterafwerking of steenstrips). Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
        vraag: "Werkt een Rotterdams bedrijf ook in Breda?",
        antwoord:
          "Ja, Breda valt binnen ons werkgebied (±80–100 km rond Rotterdam). Wij werken regelmatig in West-Brabant. Na een opname op locatie ontvangt u een vaste offerte per m².",
      },
      {
    ...
    vergunningTip: "De binnenstad van Breda heeft beschermd stadsgezicht. Of een vergunning nodig is, hangt af van uw woning, locatie en de actuele regels van de gemeente Breda. Controleer altijd de actuele regels via uw gemeente en het Omgevingsloket.",
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Bergen op Zoom en omgeving. Van de Bergse Plaat tot Gageldonk, van de Noordgeest tot het centrum — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Bergen op Zoom ligt op ±75 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Bergen op Zoom?",
        antwoord:
          "De kosten voor buitengevelisolatie in Bergen op Zoom hangen af van het woningtype en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
        vraag: "Valt Bergen op Zoom binnen het werkgebied van BM klus BV?",
        antwoord:
          "Ja, Bergen op Zoom (±75 km) valt binnen ons werkgebied van ±80–100 km rond Rotterdam. Wij werken regelmatig in West-Brabant. Na een opname op locatie ontvangt u een vaste offerte per m².",
      },
    ],
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Roosendaal en omgeving. Van Langdonk tot Kroeven, van Tolberg tot Kalsdonk — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Roosendaal ligt op ±65 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Roosendaal?",
        antwoord:
          "De prijs voor buitengevelisolatie in Roosendaal hangt af van het type woning, de oppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen en bedrijfspanden in Leidschendam-Voorburg. Van de Heuvel tot Prinsenhof, van Voorburg-West tot Stompwijk — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Leidschendam-Voorburg ligt op ±25 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
  ...
  },
  {
    ...
    intro:
      "BM klus BV verzorgt buitengevelisolatie voor woningen in Hendrik-Ido-Ambacht. Van de Volgerlanden tot de Sandelingen, van Oud-Ambacht tot de Postweg — wij adviseren u op locatie.",
    localContext:
    ...
    afstanden: "Hendrik-Ido-Ambacht ligt op ±15 km van ons kantoor — wij werken in de regio Rotterdam en omgeving (±80–100 km).",
    faq: [
      {
        vraag: "Wat kost gevelisolatie in Hendrik-Ido-Ambacht?",
        antwoord:
          "De prijs voor buitengevelisolatie in Hendrik-Ido-Ambacht hangt af van het type woning, de oppervlakte en de gekozen afwerking. Prijsindicaties verschillen per project. Bekijk de richtprijzen op onze kostenpagina of vraag een opname op locatie aan.",
      },
      {
